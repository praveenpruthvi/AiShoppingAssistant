 ...
 *
 * Uses the official HTTPS endpoint and sends the required explicit input type
 * (document or query). A configured base-URL override is rejected by the
 * endpoint policy. An API key is mandatory.
 */
final class VoyageEmbeddingProvider extends AbstractEmbeddingProvider
{
    private const DEFAULT_BASE_URL = 'https://api.voyageai.com/v1';
