...
- Do not index, embed, or generate anything synchronously inside a config save, a product save, or the indexer action; publish identifiers only after the durable queue path is activated, and rebuild through the bounded orchestration.
