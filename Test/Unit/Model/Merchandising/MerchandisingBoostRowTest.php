...
#[CoversClass(MerchandisingBoostRow::class)]
final class MerchandisingBoostRowTest extends TestCase
{
    private function row(array $overrides = []): MerchandisingBoostRow
    {
        $data = array_replace([
            'boostId' => 1,
            'productId' => 42,
    ...
    public function testAcceptsAValidBoost(): void
    {
        ...
        self::assertSame(42, $boost->productId());
    ...
    public function testRejectsANonPositiveProductId(): void
    {
        $this->expectException(MerchandisingBoostException::class);

        $this->row(['productId' => 0]);
    }
    ...
    public function testRejectsABoostWeightAboveTheMaximum(): void
    {
        ...
        $this->row(['boostWeight' => MerchandisingBoostRow::MAX_BOOST_WEIGHT + 0.01]);
    }

    public function testAllowsABoostWeightExactlyAtTheMaximum(): void
    {
        $boost = $this->row(['boostWeight' => MerchandisingBoostRow::MAX_BOOST_WEIGHT]);

        self::assertSame(MerchandisingBoostRow::MAX_BOOST_WEIGHT, $boost->boostWeight());
    }
